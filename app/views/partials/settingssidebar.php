<?php
    $menu = [
        ...
        [
            ...
            'description' => __("Define the app's global preferred language to translate the whole interface by default")
        ],
        [
            'label' => __('Storage'),
        ...
        [
            ...
            'description' => __("Get precise information about your current instance and all the settings for it")
        ]
